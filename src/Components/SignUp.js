...
export class SignUp extends Component {
  ...
  isValid(name, email, password) {
    ...
    if (name.length < 2 || name.length > 40) {
      ...
      this.setState({
        error: true,
        message:
          "The name should be at least 2 characters long and at most 40!",
      });
    } else if (
      email.search(
  ...
  render() {
    return (
      <>
        <div
          className="mx-5 my-4 p-4 border"
          style={{
            backgroundImage: `url("https://visme.co/blog/wp-content/uploads/2017/07/50-Beautiful-and-Minimalist-Presentation-Backgrounds-036.jpg")`,
        ...
        >
          <center>
            <form className="p-md-5">
              <div
                className="form-group my-2 col-md-6"
                style={{ textAlign: "left", color: "white" }}
              >
                <label htmlFor="exampleInputName" className="fs-5">
                  Name
                </label>
                <input
                  type="text"
