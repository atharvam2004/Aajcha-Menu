...
const Banner = () => {
  return (
    <div className="bg-hero text-light d-flex align-items-center flex-column justify-content-center animate__fadeIn animate__animated mt-5">
      ...
      <h2 className="mt-3 mb-4 fw-normal fs-1 py-1 text-center lh-lg">
        Effortless meal planning for a healthier you <br /> with our app!{" "}
        <MdFastfood className="fs-2 text-warning fa-fade" />{" "}
      </h2>
    </div>
  );
};
