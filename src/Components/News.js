  ...
  render() {
    return (
      <div className="container my-5">
        ...
        {!this.state.loading && !this.state.problemOccrured && (
          <div className="row">
        ...
        {this.state.isAlertPresent && (
          <div
            className={`alert alert-${this.state.alertType} mt-2 fixed-bottom mx-5`}
            role="alert"
          >
